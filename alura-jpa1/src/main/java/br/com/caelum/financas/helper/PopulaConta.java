package br.com.caelum.financas.helper;
...
public class PopulaConta {
	...
	public static void main(String[] args) {
		...
		EntityManager manager = jpaUtil.getEntityManagerWithProperties();
		
		Map<String, Object> properties = manager.getProperties();
		//System.out.println("hibernate.hbm2ddl.auto: " + properties.get("hibernate.hbm2ddl.auto"));

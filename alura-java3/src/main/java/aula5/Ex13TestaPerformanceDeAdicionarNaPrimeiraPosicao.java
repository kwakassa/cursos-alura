...
public class Ex13TestaPerformanceDeAdicionarNaPrimeiraPosicao {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		performanceTeste(new LinkedList<Integer>(), "LinkedList");
		//System.out.println();
		//performanceTeste(new HashSet<Integer>(), "HashSet");
		//System.out.println();
		//performanceTeste(new TreeSet<Integer>(), "TreeSet");
	}
}
